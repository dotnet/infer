...
Depending on the build configuration and targeted framework, the assemblies will be located in the `bin/Debug<Core|Full>/<net10.0|net472>` or `bin/Release<Core|Full>/<net10.0|net472>` subdirectories
of the test project.
