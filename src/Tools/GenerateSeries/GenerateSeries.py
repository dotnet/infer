...
digamma_asymptotic_variable_name = "dx"

trigamma_at_1_series_length = 2
trigamma_at_1_variable_name = "dx"

trigamma_asymptotic_series_length = 9
trigamma_asymptotic_variable_name = "dx"

tetragamma_at_1_series_length = 2
tetragamma_at_1_variable_name = "dx"

tetragamma_asymptotic_series_length = 9
tetragamma_asymptotic_variable_name = "dx"

gammaln_asymptotic_series_length = 7
gammaln_asymptotic_variable_name = "dx"

log_1_plus_series_length = 6
log_1_plus_variable_name = "dx"

log_1_minus_series_length = 5
log_1_minus_variable_name = "dx"

x_minus_log_1_plus_series_length = 7
x_minus_log_1_plus_variable_name = "dx"

exp_minus_1_series_length = 5
exp_minus_1_variable_name = "dx"

exp_minus_1_ratio_minus_1_ratio_minus_half_series_length = 13
exp_minus_1_ratio_minus_1_ratio_minus_half_variable_name = "dx"

log_exp_minus_1_ratio_series_length = 5
log_exp_minus_1_ratio_variable_name = "dx"

normcdfln_asymptotic_series_length = 8
normcdfln_asymptotic_variable_name = "dx"
...
def printPolyFromNumbers(varname, coefficients, indent):
    ...
    while idx < last_non_zero_idx:
        ...
        idx = idx + 1
    print(f"{varname} * {coefficients[last_non_zero_idx]}", end='')
...
def printPolyFromRationals(varname, coefficients, indent):
    if len(coefficients) <= 1:
        print(formatRationalCoefficient(coefficients[0]))
        return
    if coefficients[0] != 0:
...
def digamma_at_2_coefficient(k):
    if k == 0:
        return 0.0
    return ((-1)**(k + 1)*(zeta(k + 1) - 1)/(k + 1)/(k + 1)).evalf(decimal_precision)
...
def main():
    ...
    printPolyFromNumbers(gamma_at_2_variable_name, gamma_at_2_coefficients, "                    ")

    print("(2) - DiGamma at 2:")
    digamma_at_2_coefficients = [digamma_at_2_coefficient(k) for k in range(0, digamma_at_2_series_length)]
    printPolyFromNumbers(digamma_at_2_variable_name, digamma_at_2_coefficients, "                    ")
    ...
    printPolyFromRationals(digamma_asymptotic_variable_name, digamma_asymptotic_coefficients, "                    ")

    print("(4) - TriGamma at 1:")
    trigamma_at_1_coefficients = [trigamma_at_1_coefficient(k) for k in range(0, trigamma_at_1_series_length)]
    printPolyFromNumbers(trigamma_at_1_variable_name, trigamma_at_1_coefficients, "                    ")
    ...
    printPolyFromRationals(trigamma_asymptotic_variable_name, trigamma_asymptotic_coefficients, "                    ")
    ...
    printPolyFromNumbers(tetragamma_at_1_variable_name, tetragamma_at_1_coefficients, "                    ")
    ...
    printPolyFromRationals(tetragamma_asymptotic_variable_name, tetragamma_asymptotic_coefficients, "                    ")
    ...
    printPolyFromRationals(gammaln_asymptotic_variable_name, gammaln_asymptotic_coefficients, "                    ")

    print("(9) - log(1 + x):")
    log_1_plus_coefficients = [log_1_plus_coefficient(k) for k in range(0, log_1_plus_series_length)]
    printPolyFromRationals(log_1_plus_variable_name, log_1_plus_coefficients, "                    ")

    print("(10) - log(1 - x):")
    log_1_minus_coefficients = [log_1_minus_coefficient(k) for k in range(0, log_1_minus_series_length)]
    printPolyFromRationals(log_1_minus_variable_name, log_1_minus_coefficients, "                    ")

    print("(11) - x - log(1 + x):")
    x_minus_log_1_plus_coefficients = [x_minus_log_1_plus_coefficient(k) for k in range(0, x_minus_log_1_plus_series_length)]
    printPolyFromRationals(x_minus_log_1_plus_variable_name, x_minus_log_1_plus_coefficients, "                    ")

    print("(12) - exp(x) - 1:")
    exp_minus_1_coefficients = [exp_minus_1_coefficient(k) for k in range(0, exp_minus_1_series_length)]
    printPolyFromRationals(exp_minus_1_variable_name, exp_minus_1_coefficients, "                    ")
    ...
    printPolyFromRationals(exp_minus_1_ratio_minus_1_ratio_minus_half_variable_name, exp_minus_1_ratio_minus_1_ratio_minus_half_coefficients, "                    ")
    ...
    printPolyFromRationals(log_exp_minus_1_ratio_variable_name, log_exp_minus_1_ratio_coefficients, "                    ")
    ...
    printPolyFromRationals(normcdfln_asymptotic_variable_name, normcdfln_asymptotic_coefficients, "                    ")
