...
namespace Microsoft.ML.Probabilistic.Factors
{
    ...
    /// <include file='FactorDocs.xml' path='factor_docs/message_op_class[@name="GammaProductOp_PointB"]/doc/*'/>
    [FactorMethod(typeof(Factor), "Product", typeof(double), typeof(double))]
    [Quality(QualityBand.Preview)]
    public static class GammaProductOp_PointB
    {
        /// <include file='FactorDocs.xml' path='factor_docs/message_op_class[@name="GammaProductOp_PointB"]/message_doc[@name="ProductAverageConditional(Gamma, TruncatedGamma)"]/*'/>
        public static Gamma ProductAverageConditional(Gamma A, TruncatedGamma B)
        {
            if (B.IsPointMass)
        ...
        /// <include file='FactorDocs.xml' path='factor_docs/message_op_class[@name="GammaProductOp_PointB"]/message_doc[@name="AAverageConditional(Gamma, TruncatedGamma)"]/*'/>
        public static Gamma AAverageConditional([SkipIfUniform] Gamma product, TruncatedGamma B)
        {
            if (B.IsPointMass)
        ...
        /// <include file='FactorDocs.xml' path='factor_docs/message_op_class[@name="GammaProductOp_PointB"]/message_doc[@name="AAverageConditional(Gamma, GammaPower)"]/*'/>
        public static Gamma AAverageConditional([SkipIfUniform] Gamma product, GammaPower B)
        {
            if (B.IsPointMass)
                return GammaProductOp.AAverageConditional(product, B.Point);
            else
        ...
        /// <include file='FactorDocs.xml' path='factor_docs/message_op_class[@name="GammaProductOp_PointB"]/message_doc[@name="AAverageConditional(GammaPower, GammaPower)"]/*'/>
        public static Gamma AAverageConditional([SkipIfUniform] GammaPower product, GammaPower B)
        {
            if (B.IsPointMass && product.Power == 1)
                return GammaProductOp.AAverageConditional(Gamma.FromShapeAndRate(product.Shape, product.Rate), B.Point);
            else
                throw new ArgumentException("B is not a point mass or product.Power != 1");
        }

        /// <include file='FactorDocs.xml' path='factor_docs/message_op_class[@name="GammaProductOp_PointB"]/message_doc[@name="BAverageConditional(Gamma, Gamma, TruncatedGamma)"]/*'/>
        public static TruncatedGamma BAverageConditional([SkipIfUniform] Gamma product, [Proper] Gamma A, [Proper] TruncatedGamma B)
        {
            if (!B.IsPointMass)
                throw new ArgumentException("B is not a point mass");
            return TruncatedGamma.FromGamma(GammaProductOp_Laplace.BAverageConditional(product, A, B.Gamma, B.Gamma));
        }
    }
    ...
    public static class GammaRatioOp
    {
        ...
        {
            if (B == 0)
                return GammaPower.Uniform(ratio.Power);
        ...
        public static GammaPower RatioAverageConditional(double A, GammaPower B)
        {
        ...
        {
            if (B.Power == -1)
                return GammaProductOp.ProductAverageConditional(A, Gamma.FromShapeAndRate(B.Shape, B.Rate));
            else throw new ArgumentException("B.Power != -1");
        }
        ...
        {
            if (ratio.IsPointMass)
                return GammaPower.PointMass(BAverageConditional(ratio.Point, A).Point, -ratio.Power);
            // Ga(a/b; y_s, y_r, y_p) =propto b^(-y_s/y_p + 1) exp(-(a/b)^(1/y_p) y_r)
            // shape/-y_p -1 = -y_s/y_p + 1, shape = y_s - 2 y_p
            // rate*b^(-1/y_p) = (a/b)^(1/y_p) y_r, rate = a^(1/y_p) y_r
            return GammaPower.FromShapeAndRate(ratio.Shape - 2 * ratio.Power, ratio.Rate * Math.Pow(A, 1 / ratio.Power), -ratio.Power);
        }
        ...
        {
            if (A.IsPointMass)
                return BAverageConditional(ratio, A.Point);
            // a' = a/b,  da' = da/b
        ...
        /// <include file='FactorDocs.xml' path='factor_docs/message_op_class[@name="GammaRatioOp"]/message_doc[@name="LogEvidenceRatio(GammaPower, double, Gamma)"]/*'/>
        public static double LogEvidenceRatio(GammaPower ratio, double a, Gamma b)
        {
    ...
    {
        /// <include file='FactorDocs.xml' path='factor_docs/message_op_class[@name="GammaRatioOp_PointA"]/message_doc[@name="RatioAverageConditional(Gamma, Gamma)"]/*'/>
        public static GammaPower RatioAverageConditional(Gamma A, Gamma B)
        {
            if (A.IsPointMass)
                return GammaRatioOp.RatioAverageConditional(A.Point, B);
            else
        ...
        public static GammaPower RatioAverageConditional(Gamma A, GammaPower B)
        {
            if (A.IsPointMass)
                return GammaRatioOp.RatioAverageConditional(A.Point, B);
            else
        ...
        {
            if (A.IsPointMass)
                return GammaRatioOp.RatioAverageConditional(ratio, A.Point, B);
            else
                throw new ArgumentException("A is not a point mass");
        }
        ...
        /// <include file='FactorDocs.xml' path='factor_docs/message_op_class[@name="GammaRatioOp_PointA"]/message_doc[@name="BAverageConditional(GammaPower, Gamma)"]/*'/>
        public static GammaPower BAverageConditional([SkipIfUniform] GammaPower ratio, Gamma A)
        {
            if (A.IsPointMass)
                return GammaRatioOp.BAverageConditional(ratio, A.Point);
            else
    ...
    {
        /// <include file='FactorDocs.xml' path='factor_docs/message_op_class[@name="GammaRatioOp_PointB"]/message_doc[@name="RatioAverageConditional(Gamma, TruncatedGamma)"]/*'/>
        ...
        /// <include file='FactorDocs.xml' path='factor_docs/message_op_class[@name="GammaRatioOp_PointB"]/message_doc[@name="AAverageConditional(Gamma, TruncatedGamma)"]/*'/>
        ...
        /// <include file='FactorDocs.xml' path='factor_docs/message_op_class[@name="GammaRatioOp_PointB"]/message_doc[@name="AAverageConditional(Gamma, GammaPower)"]/*'/>
        ...
        /// <include file='FactorDocs.xml' path='factor_docs/message_op_class[@name="GammaRatioOp_PointB"]/message_doc[@name="AAverageConditional(GammaPower, GammaPower)"]/*'/>
