...
namespace Microsoft.ML.Probabilistic
{
    ...
    /// </summary>
    [Serializable]
    public class InferRuntimeException : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InferRuntimeException"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InferRuntimeException"/> class with a specified error message.
        /// </summary>
