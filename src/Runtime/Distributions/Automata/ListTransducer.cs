...
namespace Microsoft.ML.Probabilistic.Distributions.Automata
{
    ...
    public class ListTransducer<TList, TElement,TElementDist> :
        ...
        ListAutomaton<TList, TElement, TElementDist>, ListTransducer<TList, TElement, TElementDist>>
               where TElementDist : class, IImmutableDistribution<TElement, TElementDist>, CanGetLogAverageOf<TElementDist>, CanComputeProduct<TElementDist>, CanCreatePartialUniform<TElementDist>, CanComputeWeightedSumExact<TElementDist>, Sampleable<TElement>, new()
