...
namespace Microsoft.ML.Probabilistic.Learners.MatchboxRecommenderInternal
{
	public partial class MatchboxCommunityTraining_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_ItemFeatureCount_numberOfIterationsDecreased_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh52 has executed. Set this to false to force re-execution of Changed_ItemFeatureCount_numberOfIterationsDecreased_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh52</summary>
		public bool Changed_ItemFeatureCount_numberOfIterationsDecreased_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh52_isDone;
		/// <summary>True if Changed_ItemFeatureCount_numberOfIterationsDecreased_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh52 has performed initialisation. Set this to false to force re-execution of Changed_ItemFeatureCount_numberOfIterationsDecreased_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh52</summary>
		public bool Changed_ItemFeatureCount_numberOfIterationsDecreased_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh52_isInitialised;
		...
		/// <summary>True if Changed_NonZeroUserFeatureCounts_numberOfIterationsDecreased_UserCount_Init_AffinityNoiseVariance_It45 has executed. Set this to false to force re-execution of Changed_NonZeroUserFeatureCounts_numberOfIterationsDecreased_UserCount_Init_AffinityNoiseVariance_It45</summary>
		public bool Changed_NonZeroUserFeatureCounts_numberOfIterationsDecreased_UserCount_Init_AffinityNoiseVariance_It45_isDone;
		/// <summary>True if Changed_NonZeroUserFeatureCounts_numberOfIterationsDecreased_UserCount_Init_AffinityNoiseVariance_It45 has performed initialisation. Set this to false to force re-execution of Changed_NonZeroUserFeatureCounts_numberOfIterationsDecreased_UserCount_Init_AffinityNoiseVariance_It45</summary>
		public bool Changed_NonZeroUserFeatureCounts_numberOfIterationsDecreased_UserCount_Init_AffinityNoiseVariance_It45_isInitialised;
		...
		/// <summary>True if Changed_numberOfIterationsDecreased_UserFeatureCount_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh43 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_UserFeatureCount_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh43</summary>
		public bool Changed_numberOfIterationsDecreased_UserFeatureCount_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh43_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_UserFeatureCount_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh43 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_UserFeatureCount_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh43</summary>
		public bool Changed_numberOfIterationsDecreased_UserFeatureCount_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh43_isInitialised;
		...
		public double AffinityNoiseVariance
		{
			...
			set {
				if (this.AffinityNoiseVariance_field!=value) {
					...
					this.Changed_ItemFeatureCount_numberOfIterationsDecreased_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh52_isInitialised = false;
					...
					this.Changed_numberOfIterationsDecreased_UserFeatureCount_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh43_isInitialised = false;
					...
					this.Changed_NonZeroUserFeatureCounts_numberOfIterationsDecreased_UserCount_Init_AffinityNoiseVariance_It45_isInitialised = false;
		...
		public int ItemFeatureCount
		{
			...
			set {
				if (this.ItemFeatureCount_field!=value) {
					...
					this.Changed_ItemBiasFeatureWeightPriorVariance_ItemFeatureCount_isDone = false;
					this.Changed_ItemFeatureCount_numberOfIterationsDecreased_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh52_isDone = false;
					this.Changed_numberOfIterationsDecreased_ObservationCount_Ratings_UserThresholdCount_Init_AffinityNoiseVa38_isInitialised = false;
					this.Changed_numberOfIterationsDecreased_ObservationCount_UserThresholdCount_UseSharedUserThresholds_Init33_isInitialised = false;
					this.Changed_numberOfIterationsDecreased_ObservationCount_UserThresholdCount_Init_AffinityNoiseVariance_I35_isInitialised = false;
					this.Changed_numberOfIterationsDecreased_ObservationCount_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh31_isInitialised = false;
		...
		public IReadOnlyList<int> NonZeroUserFeatureCounts
		{
			...
			set {
				...
				this.Changed_NonZeroUserFeatureCounts_numberOfIterationsDecreased_UserCount_Init_AffinityNoiseVariance_It45_isDone = false;
				this.Changed_numberOfIterationsDecreased_UserBiasInitializer_UserCount_Init_AffinityNoiseVariance_ItemBia17_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_UserCount_UserThresholdCount_UserThresholdsInitializer_Init_Affi23_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_UserCount_UserThresholdCount_Init_AffinityNoiseVariance_ItemBias20_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_UserCount_UserThresholdCount_UseSharedUserThresholds_Init_Affini21_isInitialised = false;
		...
		public int UserFeatureCount
		{
			...
			set {
				if (this.UserFeatureCount_field!=value) {
					...
					this.Changed_numberOfIterationsDecreased_UserFeatureCount_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh43_isDone = false;
					this.Changed_UserBiasFeatureWeightPriorVariance_UserFeatureCount_isDone = false;
					this.Changed_ItemFeatureCount_numberOfIterationsDecreased_TraitCount_Init_AffinityNoiseVariance_ItemBiasF47_isInitialised = false;
					this.Changed_TraitCount_UserFeatureCount_isDone = false;
					this.Changed_TraitCount_UserFeatureCount_UserTraitFeatureWeightPriorVariance_isDone = false;
		...
		/// <summary>Computations that depend on the observed value of ItemFeatureCount and numberOfIterationsDecreased and must reset on changes to AffinityNoiseVariance and ItemBiasFeatureWeightPriorVariance and ItemBiasInitializer and ItemBiasMessage and ItemBiasVariance and ItemCount and ItemIds and ItemTraitFeatureWeightPriorVariance and ItemTraitsInitializer and ItemTraitsMessage and ItemTraitVariance and MiddleUserThresholdIndex and NonZeroItemFeatureCounts and NonZeroItemFeatureIndices and NonZeroItemFeatureValues and NonZeroUserFeatureCounts and NonZeroUserFeatureIndices and NonZeroUserFeatureValues and ObservationCount and Ratings and TraitCount and UserBiasFeatureWeightPriorVariance and UserBiasInitializer and UserBiasMessage and UserBiasVariance and UserCount and UserFeatureCount and UserIds and UserThresholdCount and UserThresholdNoiseVariance and UserThresholdPriorMean and UserThresholdPriorVariance and UserThresholdsInitializer and UserThresholdsMessage and UserTraitFeatureWeightPriorVariance and UserTraitsInitializer and UserTraitsMessage and UserTraitVariance and UseSharedUserThresholds</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_ItemFeatureCount_numberOfIterationsDecreased_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh52(bool initialise)
		{
			if (this.Changed_ItemFeatureCount_numberOfIterationsDecreased_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh52_isDone&&((!initialise)||this.Changed_ItemFeatureCount_numberOfIterationsDecreased_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh52_isInitialised)) {
				return ;
			}
			for(int itemFeature = 0; itemFeature<this.ItemFeatureCount; itemFeature++) {
				this.ItemBiasFeatureWeights_marginal_F[itemFeature] = Gaussian.Uniform();
			}
			this.Changed_ItemFeatureCount_numberOfIterationsDecreased_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh52_isDone = true;
			this.Changed_ItemFeatureCount_numberOfIterationsDecreased_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh52_isInitialised = true;
		}
		...
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_NonZeroUserFeatureCounts_numberOfIterationsDecreased_UserCount_Init_AffinityNoiseVariance_It45(bool initialise)
		{
			if (this.Changed_NonZeroUserFeatureCounts_numberOfIterationsDecreased_UserCount_Init_AffinityNoiseVariance_It45_isDone&&((!initialise)||this.Changed_NonZeroUserFeatureCounts_numberOfIterationsDecreased_UserCount_Init_AffinityNoiseVariance_It45_isInitialised)) {
				return ;
			}
			for(int user = 0; user<this.UserCount; user++) {
				for(int nonZeroUserFeature = 0; nonZeroUserFeature<this.NonZeroUserFeatureCounts[user]; nonZeroUserFeature++) {
			...
			this.Changed_NonZeroUserFeatureCounts_numberOfIterationsDecreased_UserCount_Init_AffinityNoiseVariance_It45_isDone = true;
			this.Changed_NonZeroUserFeatureCounts_numberOfIterationsDecreased_UserCount_Init_AffinityNoiseVariance_It45_isInitialised = true;
		}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and UserFeatureCount and must reset on changes to AffinityNoiseVariance and ItemBiasFeatureWeightPriorVariance and ItemBiasInitializer and ItemBiasMessage and ItemBiasVariance and ItemCount and ItemFeatureCount and ItemIds and ItemTraitFeatureWeightPriorVariance and ItemTraitsInitializer and ItemTraitsMessage and ItemTraitVariance and MiddleUserThresholdIndex and NonZeroItemFeatureCounts and NonZeroItemFeatureIndices and NonZeroItemFeatureValues and NonZeroUserFeatureCounts and NonZeroUserFeatureIndices and NonZeroUserFeatureValues and ObservationCount and Ratings and TraitCount and UserBiasFeatureWeightPriorVariance and UserBiasInitializer and UserBiasMessage and UserBiasVariance and UserCount and UserIds and UserThresholdCount and UserThresholdNoiseVariance and UserThresholdPriorMean and UserThresholdPriorVariance and UserThresholdsInitializer and UserThresholdsMessage and UserTraitFeatureWeightPriorVariance and UserTraitsInitializer and UserTraitsMessage and UserTraitVariance and UseSharedUserThresholds</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_UserFeatureCount_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh43(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_UserFeatureCount_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh43_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_UserFeatureCount_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh43_isInitialised)) {
				return ;
			}
			for(int userFeature = 0; userFeature<this.UserFeatureCount; userFeature++) {
				this.UserBiasFeatureWeights_marginal_F[userFeature] = Gaussian.Uniform();
			}
			this.Changed_numberOfIterationsDecreased_UserFeatureCount_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh43_isDone = true;
			this.Changed_numberOfIterationsDecreased_UserFeatureCount_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh43_isInitialised = true;
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_ItemFeatureCount_numberOfIterationsDecreased_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh52(initialise);
			...
			this.Changed_numberOfIterationsDecreased_UserFeatureCount_Init_AffinityNoiseVariance_ItemBiasFeatureWeigh43(initialise);
			...
			this.Changed_NonZeroUserFeatureCounts_numberOfIterationsDecreased_UserCount_Init_AffinityNoiseVariance_It45(initialise);
