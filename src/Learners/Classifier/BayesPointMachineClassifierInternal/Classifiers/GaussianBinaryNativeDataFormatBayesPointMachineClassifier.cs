...
namespace Microsoft.ML.Probabilistic.Learners.BayesPointMachineClassifierInternal
{
        ...
        BinaryNativeDataFormatBayesPointMachineClassifier<TInstanceSource, TInstance, TLabelSource, GaussianBayesPointMachineClassifierTrainingSettings>
    {
        ...
        /// <see cref="GaussianBinaryNativeDataFormatBayesPointMachineClassifier{TInstanceSource, TInstance, TLabelSource}"/> class.
        /// </summary>
            ...
            : base(reader, mapping)
        {
            ...
            if (deserializedVersion == CustomSerializationVersion)
            {
                ...
                this.Settings = new GaussianBinaryBayesPointMachineClassifierSettings<bool>(reader, () => this.IsTrained);

                if (this.IsTrained)
                {
                    this.InferenceAlgorithms = new GaussianBinaryFactorizedInferenceAlgorithms(reader);
                }
            }
        }
