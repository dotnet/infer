...
namespace Microsoft.ML.Probabilistic.Learners.BayesPointMachineClassifierInternal
{
        ...
        MulticlassNativeDataFormatBayesPointMachineClassifier<TInstanceSource, TInstance, TLabelSource, BayesPointMachineClassifierTrainingSettings>
    {
        ...
        /// <see cref="CompoundMulticlassNativeDataFormatBayesPointMachineClassifier{TInstanceSource, TInstance, TLabelSource}"/> class.
        /// </summary>
            ...
            : base(reader, mapping)
        {
            ...
            if (deserializedVersion == CustomSerializationVersion)
            {
                ...
                this.Settings = new MulticlassBayesPointMachineClassifierSettings<int>(reader, () => this.IsTrained);

                if (this.IsTrained)
                {
                    this.InferenceAlgorithms = new CompoundMulticlassFactorizedInferenceAlgorithms(reader);
                }
            }
        }
