...
namespace Microsoft.ML.Probabilistic.Learners.BayesPointMachineClassifierInternal
{
        ...
        MulticlassStandardDataFormatBayesPointMachineClassifier<TInstanceSource, TInstance, TLabelSource, TLabel, GaussianBayesPointMachineClassifierTrainingSettings>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the 
        /// <see cref="GaussianMulticlassStandardDataFormatBayesPointMachineClassifier{TInstanceSource,TInstance,TLabelSource,TLabel}"/>
            ...
            : base(reader, standardMapping)
        {
            ...
            if (deserializedVersion == CustomSerializationVersion)
            {
                ...
                this.Classifier = new GaussianMulticlassNativeDataFormatBayesPointMachineClassifier<TInstanceSource, TInstance, TLabelSource>(reader, this.NativeMapping);
                this.Settings = new GaussianMulticlassBayesPointMachineClassifierSettings<TLabel>(reader, () => this.Classifier.IsTrained);
            }
        }
