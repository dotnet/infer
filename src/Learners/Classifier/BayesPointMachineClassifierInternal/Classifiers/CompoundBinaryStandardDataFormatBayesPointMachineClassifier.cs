...
namespace Microsoft.ML.Probabilistic.Learners.BayesPointMachineClassifierInternal
{
        ...
        BinaryStandardDataFormatBayesPointMachineClassifier<TInstanceSource, TInstance, TLabelSource, TLabel, BayesPointMachineClassifierTrainingSettings>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the 
        /// <see cref="CompoundBinaryStandardDataFormatBayesPointMachineClassifier{TInstanceSource,TInstance,TLabelSource,TLabel}"/> 
            ...
            : base(reader, standardMapping)
        {
            ...
            if (deserializedVersion == CustomSerializationVersion)
            {
                ...
                this.Classifier = new CompoundBinaryNativeDataFormatBayesPointMachineClassifier<TInstanceSource, TInstance, TLabelSource>(reader, this.NativeMapping);
                this.Settings = new BinaryBayesPointMachineClassifierSettings<TLabel>(reader, () => this.Classifier.IsTrained);
            }
        }
