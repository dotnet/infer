...
namespace Microsoft.ML.Probabilistic.Learners.BayesPointMachineClassifierInternal
{
        ...
        MulticlassStandardDataFormatBayesPointMachineClassifier<TInstanceSource, TInstance, TLabelSource, TLabel, BayesPointMachineClassifierTrainingSettings>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the 
        /// <see cref="CompoundMulticlassStandardDataFormatBayesPointMachineClassifier{TInstanceSource,TInstance,TLabelSource,TLabel}"/> 
            ...
            : base(reader, standardMapping)
        {
            ...
            if (deserializedVersion == CustomSerializationVersion)
            {
                ...
                this.Classifier = new CompoundMulticlassNativeDataFormatBayesPointMachineClassifier<TInstanceSource, TInstance, TLabelSource>(reader, this.NativeMapping);
                this.Settings = new MulticlassBayesPointMachineClassifierSettings<TLabel>(reader, () => this.Classifier.IsTrained);
            }
        }
