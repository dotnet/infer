...
namespace Microsoft.ML.Probabilistic.Learners.BayesPointMachineClassifierInternal
{
	public partial class CompoundSparseBinaryBpmTraining_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_FeatureCount_numberOfIterationsDecreased_WeightConstraints_Init_FeatureIndexes_FeatureValues11 has executed. Set this to false to force re-execution of Changed_FeatureCount_numberOfIterationsDecreased_WeightConstraints_Init_FeatureIndexes_FeatureValues11</summary>
		public bool Changed_FeatureCount_numberOfIterationsDecreased_WeightConstraints_Init_FeatureIndexes_FeatureValues11_isDone;
		/// <summary>True if Changed_FeatureCount_numberOfIterationsDecreased_WeightConstraints_Init_FeatureIndexes_FeatureValues11 has performed initialisation. Set this to false to force re-execution of Changed_FeatureCount_numberOfIterationsDecreased_WeightConstraints_Init_FeatureIndexes_FeatureValues11</summary>
		public bool Changed_FeatureCount_numberOfIterationsDecreased_WeightConstraints_Init_FeatureIndexes_FeatureValues11_isInitialised;
		...
		public int FeatureCount
		{
			...
			set {
				if (this.FeatureCount_field!=value) {
					...
					this.Changed_FeatureCount_numberOfIterationsDecreased_WeightConstraints_Init_FeatureIndexes_FeatureValues11_isDone = false;
		...
		public int[][] FeatureIndexes
		{
			...
			set {
				...
				this.Changed_FeatureCount_numberOfIterationsDecreased_WeightConstraints_Init_FeatureIndexes_FeatureValues11_isInitialised = false;
				this.Changed_FeatureCount_FeatureIndexes_InstanceCount_InstanceFeatureCounts_numberOfIterationsDecreased_12_isDone = false;
				this.Changed_FeatureCount_FeatureIndexes_FeatureValues_InstanceCount_InstanceFeatureCounts_Labels_numberO13_isDone = false;
			}
		}
		...
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_FeatureCount_numberOfIterationsDecreased_WeightConstraints_Init_FeatureIndexes_FeatureValues11(bool initialise)
		{
			if (this.Changed_FeatureCount_numberOfIterationsDecreased_WeightConstraints_Init_FeatureIndexes_FeatureValues11_isDone&&((!initialise)||this.Changed_FeatureCount_numberOfIterationsDecreased_WeightConstraints_Init_FeatureIndexes_FeatureValues11_isInitialised)) {
				return ;
			}
			this.Weights_uses_F[1] = ReplicateOp_NoDivide.UsesAverageConditional<DistributionStructArray<Gaussian,double>>(this.Weights_uses_B, this.Weights_F, 1, this.Weights_uses_F[1]);
			this.Changed_FeatureCount_numberOfIterationsDecreased_WeightConstraints_Init_FeatureIndexes_FeatureValues11_isDone = true;
			this.Changed_FeatureCount_numberOfIterationsDecreased_WeightConstraints_Init_FeatureIndexes_FeatureValues11_isInitialised = true;
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_FeatureCount_numberOfIterationsDecreased_WeightConstraints_Init_FeatureIndexes_FeatureValues11(initialise);
