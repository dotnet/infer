...
{
	public partial class GaussianDenseBinaryVectorBpmTrainingEvidence_EP : IGeneratedAlgorithm
	{
		#region Fields
		...
		private void Changed_FeatureValues_InstanceCount_Labels_numberOfIterations_WeightConstraints_WeightPriors(int numberOfIterations)
		{
			...
			this.Weights_uses_F[0] = ReplicateOp_NoDivide.UsesAverageConditional<VectorGaussian>(this.Weights_uses_B, this.WeightPriors, 0, this.Weights_uses_F[0]);
			this.ModelSelector_selector_cases_0_uses_B[6] = Bernoulli.FromLogOdds(ReplicateOp.LogEvidenceRatio<VectorGaussian>(this.Weights_uses_B, this.WeightPriors, this.Weights_uses_F));
			this.ModelSelector_selector_cases_0_uses_B[7] = Bernoulli.FromLogOdds(ConstrainEqualRandomOp<Vector>.LogEvidenceRatio<VectorGaussian>(this.Weights_uses_F[0], this.WeightConstraints));
			this.ModelSelector_selector_cases_0_uses_B[11] = Bernoulli.FromLogOdds(ReplicateOp.LogEvidenceRatio<VectorGaussian>(this.Weights_rep_B, this.Weights_uses_F[1], this.Weights_rep_F));
			for(int InstanceRange = 0; InstanceRange<this.InstanceCount; InstanceRange++) {
				this.ModelSelector_selector_cases_0_rep5_B[InstanceRange] = Bernoulli.FromLogOdds(IsPositiveOp.LogEvidenceRatio(this.Labels[InstanceRange], this.NoisyScore_F[InstanceRange]));
			}
			this.ModelSelector_selector_cases_0_uses_B[14] = ReplicateOp_NoDivide.DefAverageConditional<Bernoulli>(this.ModelSelector_selector_cases_0_rep5_B, this.ModelSelector_selector_cases_0_uses_B[14]);
		...
		private void Changed_InstanceCount()
		{
			...
			this.ModelSelector_selector_cases_0_rep5_B = new Bernoulli[this.InstanceCount];
			for(int InstanceRange = 0; InstanceRange<this.InstanceCount; InstanceRange++) {
				this.ModelSelector_selector_cases_0_rep5_B[InstanceRange] = Bernoulli.Uniform();
			}
		...
		private void Changed_WeightPriors()
		{
			...
			this.Weights_uses_F[0] = ArrayHelper.MakeUniform<VectorGaussian>(this.WeightPriors);
		...
		private void Constant()
		{
			...
			this.ModelSelector_selector_cases_0_uses_B = new Bernoulli[15];
