...
namespace Microsoft.ML.Probabilistic.Learners.BayesPointMachineClassifierInternal
{
	public partial class GaussianDenseMulticlassBpmTrainingEvidence_EP : IGeneratedAlgorithm
	{
		...
		public DistributionStructArray<Bernoulli,bool>[] ModelSelector_selector_cases_0_rep24_rep_B;
		...
		public DistributionStructArray<Bernoulli,bool>[] ModelSelector_selector_cases_0_rep25_rep_B;
		...
		public DistributionStructArray<Bernoulli,bool>[] ModelSelector_selector_cases_0_rep4_rep_B;
		...
		private void Changed_ClassCount()
		{
			...
			this.ModelSelector_selector_cases_0_rep4_rep_B = new DistributionStructArray<Bernoulli,bool>[this.classCount];
		...
		private void Changed_InstanceCount()
		{
			...
			this.ModelSelector_selector_cases_0_rep24_rep_B = new DistributionStructArray<Bernoulli,bool>[this.instanceCount];
			...
			this.ModelSelector_selector_cases_0_rep25_rep_B = new DistributionStructArray<Bernoulli,bool>[this.instanceCount];
			for(int InstanceRange = 0; InstanceRange<this.instanceCount; InstanceRange++) {
