...
namespace Microsoft.ML.Probabilistic.Learners.BayesPointMachineClassifierInternal
{
	public partial class CompoundDenseBinaryBpmTraining_EP : IGeneratedAlgorithm
	{
		...
		private void Changed_FeatureCount()
		{
			...
			this.Weights_rep_F = new DistributionStructArray<Gaussian,double>[this.featureCount];
			this.Weights_rep_B = new DistributionStructArray<Gaussian,double>[this.featureCount];
