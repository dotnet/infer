...
{
	public partial class GaussianDenseBinaryVectorBpmPrediction_EP : IGeneratedAlgorithm
	{
		#region Fields
		/// <summary>True if Changed_FeatureValues_InstanceCount_WeightConstraints_WeightPriors has executed. Set this to false to force re-execution of Changed_FeatureValues_InstanceCount_WeightConstraints_WeightPriors</summary>
		public bool Changed_FeatureValues_InstanceCount_WeightConstraints_WeightPriors_isDone;
		...
		/// <summary>True if Changed_InstanceCount_WeightConstraints_WeightPriors has executed. Set this to false to force re-execution of Changed_InstanceCount_WeightConstraints_WeightPriors</summary>
		public bool Changed_InstanceCount_WeightConstraints_WeightPriors_isDone;
		...
		public Vector[] FeatureValues
		{
			...
			set {
				...
				this.Changed_FeatureValues_InstanceCount_WeightConstraints_WeightPriors_isDone = false;
			}
		}
		...
		public int InstanceCount
		{
			...
			set {
				if (this.InstanceCount_field!=value) {
					...
					this.Changed_InstanceCount_WeightConstraints_WeightPriors_isDone = false;
					this.Changed_FeatureValues_InstanceCount_WeightConstraints_WeightPriors_isDone = false;
				}
			}
		}
		...
		#region Methods
		/// <summary>Computations that depend on the observed value of FeatureValues and InstanceCount and WeightConstraints and WeightPriors</summary>
		private void Changed_FeatureValues_InstanceCount_WeightConstraints_WeightPriors()
		{
			if (this.Changed_FeatureValues_InstanceCount_WeightConstraints_WeightPriors_isDone) {
				return ;
			}
			...
			this.Changed_FeatureValues_InstanceCount_WeightConstraints_WeightPriors_isDone = true;
		}
		...
		/// <summary>Computations that depend on the observed value of InstanceCount and WeightConstraints and WeightPriors</summary>
		private void Changed_InstanceCount_WeightConstraints_WeightPriors()
		{
			if (this.Changed_InstanceCount_WeightConstraints_WeightPriors_isDone) {
				return ;
			}
			for(int InstanceRange = 0; InstanceRange<this.InstanceCount; InstanceRange++) {
			...
			this.Changed_InstanceCount_WeightConstraints_WeightPriors_isDone = true;
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_InstanceCount_WeightConstraints_WeightPriors();
			this.Changed_FeatureValues_InstanceCount_WeightConstraints_WeightPriors();
