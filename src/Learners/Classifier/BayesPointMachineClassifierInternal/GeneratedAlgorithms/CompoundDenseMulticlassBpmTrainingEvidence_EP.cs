...
namespace Microsoft.ML.Probabilistic.Learners.BayesPointMachineClassifierInternal
{
	public partial class CompoundDenseMulticlassBpmTrainingEvidence_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_ClassCount_FeatureCount_FeatureValues_InstanceCount_numberOfIterationsDecreased_WeightConstr14 has performed initialisation. Set this to false to force re-execution of Changed_ClassCount_FeatureCount_FeatureValues_InstanceCount_numberOfIterationsDecreased_WeightConstr14</summary>
		public bool Changed_ClassCount_FeatureCount_FeatureValues_InstanceCount_numberOfIterationsDecreased_WeightConstr14_isInitialised;
		...
		/// <summary>True if Changed_ClassCount_FeatureCount_InstanceCount_numberOfIterationsDecreased_Init_FeatureValues_Labels_16 has executed. Set this to false to force re-execution of Changed_ClassCount_FeatureCount_InstanceCount_numberOfIterationsDecreased_Init_FeatureValues_Labels_16</summary>
		public bool Changed_ClassCount_FeatureCount_InstanceCount_numberOfIterationsDecreased_Init_FeatureValues_Labels_16_isDone;
		/// <summary>True if Changed_ClassCount_FeatureCount_InstanceCount_numberOfIterationsDecreased_Init_FeatureValues_Labels_16 has performed initialisation. Set this to false to force re-execution of Changed_ClassCount_FeatureCount_InstanceCount_numberOfIterationsDecreased_Init_FeatureValues_Labels_16</summary>
		public bool Changed_ClassCount_FeatureCount_InstanceCount_numberOfIterationsDecreased_Init_FeatureValues_Labels_16_isInitialised;
		...
		/// <summary>The constant 'vbool60'</summary>
		public bool[][][] vbool60;
		...
		public int ClassCount
		{
			...
			set {
				if (this.ClassCount_field!=value) {
					...
					this.Changed_ClassCount_FeatureCount_InstanceCount_numberOfIterationsDecreased_Init_FeatureValues_Labels_16_isDone = false;
		...
		public double[][] FeatureValues
		{
			...
			set {
				...
				this.Changed_ClassCount_InstanceCount_Labels_numberOfIterationsDecreased_Init_FeatureCount_FeatureValues_21_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_ClassCount_FeatureCount_FeatureValues_InstanceCount_Labels_8_isInitialised = false;
				this.Changed_ClassCount_FeatureCount_InstanceCount_numberOfIterationsDecreased_Init_FeatureValues_Labels_16_isInitialised = false;
		...
		public int[] Labels
		{
			...
			set {
				...
				this.Changed_ClassCount_FeatureCount_FeatureValues_InstanceCount_numberOfIterationsDecreased_WeightConstr14_isInitialised = false;
				this.Changed_ClassCount_FeatureCount_FeatureValues_InstanceCount_Labels_numberOfIterationsDecreased_Weigh22_isDone = false;
				this.Changed_ClassCount_FeatureCount_FeatureValues_InstanceCount_Labels_numberOfIterations_WeightConstrai23_isDone = false;
			}
		}
		...
		private void Changed_ClassCount_FeatureCount_FeatureValues_InstanceCount_numberOfIterationsDecreased_WeightConstr14(bool initialise)
		{
			if (this.Changed_ClassCount_FeatureCount_FeatureValues_InstanceCount_numberOfIterationsDecreased_WeightConstr14_isDone&&((!initialise)||this.Changed_ClassCount_FeatureCount_FeatureValues_InstanceCount_numberOfIterationsDecreased_WeightConstr14_isInitialised)) {
				return ;
			}
			for(int FeatureRange = 0; FeatureRange<this.FeatureCount; FeatureRange++) {
				for(int ClassRange = 0; ClassRange<this.ClassCount; ClassRange++) {
			...
			this.Changed_ClassCount_FeatureCount_FeatureValues_InstanceCount_numberOfIterationsDecreased_WeightConstr14_isInitialised = true;
		}
		...
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_ClassCount_FeatureCount_InstanceCount_numberOfIterationsDecreased_Init_FeatureValues_Labels_16(bool initialise)
		{
			if (this.Changed_ClassCount_FeatureCount_InstanceCount_numberOfIterationsDecreased_Init_FeatureValues_Labels_16_isDone&&((!initialise)||this.Changed_ClassCount_FeatureCount_InstanceCount_numberOfIterationsDecreased_Init_FeatureValues_Labels_16_isInitialised)) {
				return ;
			}
			for(int InstanceRange = 0; InstanceRange<this.InstanceCount; InstanceRange++) {
				for(int FeatureRange = 0; FeatureRange<this.FeatureCount; FeatureRange++) {
			...
			this.Changed_ClassCount_FeatureCount_InstanceCount_numberOfIterationsDecreased_Init_FeatureValues_Labels_16_isDone = true;
			this.Changed_ClassCount_FeatureCount_InstanceCount_numberOfIterationsDecreased_Init_FeatureValues_Labels_16_isInitialised = true;
		}
		...
		private void Changed_ClassCount_InstanceCount_Labels()
		{
			...
			for(int InstanceRange = 0; InstanceRange<this.InstanceCount; InstanceRange++) {
				...
				this.vbool60[InstanceRange] = new bool[this.ClassCount][];
				for(int ClassRange = 0; ClassRange<this.ClassCount; ClassRange++) {
					this.ModelSelector_selector_cases_0_rep33_rep_B[InstanceRange][ClassRange] = Bernoulli.Uniform();
				}
				for(int ClassMaxNoisyScore = 0; ClassMaxNoisyScore<this.ClassCount; ClassMaxNoisyScore++) {
					if (this.Labels[InstanceRange]==ClassMaxNoisyScore) {
						this.vbool60[InstanceRange][ClassMaxNoisyScore] = new bool[this.ClassCount];
					}
				}
				for(int ClassRange = 0; ClassRange<this.ClassCount; ClassRange++) {
					for(int ClassMaxNoisyScore = 0; ClassMaxNoisyScore<this.ClassCount; ClassMaxNoisyScore++) {
						if (this.Labels[InstanceRange]==ClassMaxNoisyScore) {
							if (ClassMaxNoisyScore!=ClassRange) {
								this.vbool60[InstanceRange][ClassMaxNoisyScore][ClassRange] = true;
								this.ModelSelector_selector_cases_0_rep33_rep_B[InstanceRange][ClassRange] = Bernoulli.FromLogOdds(ConstrainEqualOp<bool>.LogEvidenceRatio(true, this.vbool60[InstanceRange][ClassMaxNoisyScore][ClassRange]));
							}
						}
					}
				}
		...
		private void Changed_InstanceCount()
		{
			...
			this.vbool60 = new bool[this.InstanceCount][][];
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_ClassCount_FeatureCount_InstanceCount_numberOfIterationsDecreased_Init_FeatureValues_Labels_16(initialise);
			...
			this.Changed_ClassCount_FeatureCount_FeatureValues_InstanceCount_numberOfIterationsDecreased_WeightConstr14(initialise);
