...
namespace Microsoft.ML.Probabilistic.Learners.BayesPointMachineClassifierInternal
{
	public partial class CompoundDenseMulticlassBpmTrainingEvidence_EP : IGeneratedAlgorithm
	{
		...
		public DistributionStructArray<Bernoulli,bool>[] ModelSelector_selector_cases_0_rep11_rep_B;
		...
		public DistributionStructArray<Bernoulli,bool>[] ModelSelector_selector_cases_0_rep18_rep_B;
		...
		public DistributionStructArray<Bernoulli,bool>[] ModelSelector_selector_cases_0_rep32_rep_B;
		...
		public DistributionStructArray<Bernoulli,bool>[] ModelSelector_selector_cases_0_rep33_rep_B;
		...
		public DistributionStructArray<Bernoulli,bool>[] ModelSelector_selector_cases_0_rep5_rep_B;
		...
		public DistributionStructArray<Bernoulli,bool>[] ModelSelector_selector_cases_0_rep9_rep_B;
		...
		public DistributionStructArray<Gamma,double>[] WeightPrecisionRates_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Gamma&gt;</summary>
		...
		private void Changed_ClassCount()
		{
			...
			this.ModelSelector_selector_cases_0_rep5_rep_B = new DistributionStructArray<Bernoulli,bool>[this.classCount];
			...
			this.ModelSelector_selector_cases_0_rep9_rep_B = new DistributionStructArray<Bernoulli,bool>[this.classCount];
			...
			this.ModelSelector_selector_cases_0_rep18_rep_B = new DistributionStructArray<Bernoulli,bool>[this.classCount];
		...
		private void Changed_FeatureCount()
		{
			...
			this.WeightPrecisionRates_rep_F = new DistributionStructArray<Gamma,double>[this.featureCount];
		...
		private void Changed_InstanceCount()
		{
			...
			this.ModelSelector_selector_cases_0_rep11_rep_B = new DistributionStructArray<Bernoulli,bool>[this.instanceCount];
			...
			this.ModelSelector_selector_cases_0_rep32_rep_B = new DistributionStructArray<Bernoulli,bool>[this.instanceCount];
			...
			this.ModelSelector_selector_cases_0_rep33_rep_B = new DistributionStructArray<Bernoulli,bool>[this.instanceCount];
			for(int InstanceRange = 0; InstanceRange<this.instanceCount; InstanceRange++) {
