...
namespace Microsoft.ML.Probabilistic.Learners.Runners
{
    ...
    internal class BinaryBayesPointMachineClassifierIncrementalTrainingModule : CommandLineModule
    {
        ...
        public override bool Run(string[] args, string usagePrefix)
        {
            ...
            var classifier = BayesPointMachineClassifier.LoadBinaryClassifier<IList<LabeledFeatureValues>, LabeledFeatureValues, IList<LabelDistribution>, string, IDictionary<string, double>>(inputModelFile, formatter);
