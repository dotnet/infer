...
If this flag is set to true, the [Model Specification Language (MSL)](The Model Specification Language.md) version of your model will be written to the Console.  To make this code readable, you should [attach names](Creating variables.md) to the variables in the model.
