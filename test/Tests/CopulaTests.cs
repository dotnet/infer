...
namespace Microsoft.ML.Probabilistic.Tests
{
    ...
    public class CopulaTests
    {
        ...
        [Fact]
        public void CopulaFactory_CreatesGaussian()
        {
            IBivariateCopula c = CopulaFactory.Create(CopulaFamily.Gaussian);
            Assert.Equal("Gaussian", c.Name);
            Assert.Throws<NotImplementedException>(() => CopulaFactory.Create(CopulaFamily.Clayton));
        }
