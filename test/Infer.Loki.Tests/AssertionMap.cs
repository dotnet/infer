...
namespace Infer.Loki.Tests
{
    class AssertionMap : IMap
    {
        ...
        {
            mappers.ManagedMethodMapper.CreateMap<Func<double, double, bool>, Func<BigFloat, BigFloat, bool>>(SpecialFunctionsTests.IsErrorSignificant, IsErrorSignificantPreciser);
        }
    }
}
